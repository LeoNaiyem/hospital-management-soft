    ...
    <div class="card mb-3">
        ...
        <div class="table-responsive rounded-3">
            <table class="table table-hover">
                <thead class="table-primary"><tr><th>Id</th><th>Name</th><th>Mobile</th><th>Dob</th><th>Mob ext</th><th>Gender</th><th>Profession</th><th>Actions</th></tr></thead>
                <tbody>
                @foreach ($patients as $item)
                    <tr><td>{{ $item->id }}</td><td>{{ $item->name }}</td><td>{{ $item->mobile }}</td><td>{{ $item->dob }}</td><td>{{ $item->mob_ext }}</td><td>{{ $item->gender }}</td><td>{{ $item->profession }}</td><td>
