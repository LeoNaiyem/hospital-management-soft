...
@section('page-content')
    <div class="page-inner">
        ...
        <div class="card bg-info mb-3 p-4">
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-item-center ">
                    <h3 class=" card-title text-white d-flex align-items-center  m-0">Edit MedicineCategory</h3>
        ...
        <div class="card p-4"> 
            <form action="{{ route('medicine_categories.update', $medicineCategory->id) }}" method="POST" enctype="multipart/form-data">
