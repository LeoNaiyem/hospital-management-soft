            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('consultants.edit', $consultant->id) }}" class="btn btn-warning btn-sm" title="Edit">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 d-flex justify-content-between">
                    ...
                    @if(isset($consultant->status))
                        <span class="badge 
                            @if($consultant->status == 'active') bg-success @endif
                            @if($consultant->status == 'inactive') bg-danger @endif
                            @if($consultant->status == 'pending') bg-warning @endif">
