    ...
    <div class="container">
        <div class=" prescription-card my-5 position-relative card ps-wrapper">
            ...
            <div class="ps-body">
                ...
                <div class="row ps-head">
                    <div class="col-9 d-flex gap-4">
                        <div style="min-width: 345px" class="doctor-section pe-5 border-end border-info-subtle">
                ...
                <div class="row ps-main column-gap-5 my-5 px-5">
                    <div class="col-8 border-end border-info-subtle pe-4">
                        ...
                        <div class="d-flex my-4 align-items-center gap-2">
                            <div class="" style="min-width: 150px; max-width: 200px;">
                                ...
                                <select name="medicine-id" id="medicine-id" class="form-select py-1 px-2">
                            ...
                            <div class="" style="min-width: 150px; max-width: 200px;">
                                ...
                                <select id='dose' name="dose_schedule" class="form-select py-1 px-2">
                            ...
                            <div class="">
                                ...
                                <select style="min-width: 100px;" id='course' name="course" class="form-select py-1 px-2">
                            ...
                            <div class=" mt-4">
                                <input id="add" type="submit" value="Add" class="btn btn-info py-1 px-2">
                            </div>
                        </div>
                    ...
                    <div class="col-3">
                        ...
                        <div class="d-flex gap-2 align-items-center my-2">
                            <select name="diagnosis" id="diagnosis" class="form-select px-2 py-1">
                                <option value="">----Select Tests----</option>
                                @foreach ($services as $service)
                                    <option value="{{ $service->name }}">{{ $service->name }}</option>
                                @endforeach
                            </select>
                            <button id="add-diagnosis" class="btn mt-0 py-1 px-2 btn-info">
                                Add
                            </button>
                        </div>
                        {{-- will be added here --}}
                        <ol id='diagnosis-container' class="list-group list-group-numbered mt-1 mb-3">
            ...
            <div class="ps-bottom position-relative">
                ...
                <button id="save-btn" class="btn py-1 px-2 btn-lg btn-info position-absolute top-25 start-50">
