        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <td>{{ $appointment->appointment_at ?? 'N/A' }}</td>
                </tr>                <tr>
                    <th>Cc</th>
                    <td>{{ $appointment->cc ?? 'N/A' }}</td>
                </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="mt-4 d-flex justify-content-between">
                    ...
                    @if(isset($appointment->status))
                        <span class="badge 
                            @if($appointment->status == 'active') bg-success @endif
                            @if($appointment->status == 'inactive') bg-danger @endif
