            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('designations.edit', $designation->id) }}" class="btn btn-warning btn-sm" title="Edit">
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <th>Created at</th>
                    <td>{{ $designation->created_at ?? 'N/A' }}</td>
                </tr>                <tr>
                    <th>Updated at</th>
                ...
                <div class="mt-4 d-flex justify-content-between">
                    ...
                    @if(isset($designation->status))
                        <span class="badge 
                            @if($designation->status == 'active') bg-success @endif
                            @if($designation->status == 'inactive') bg-danger @endif
                            @if($designation->status == 'pending') bg-warning @endif">
