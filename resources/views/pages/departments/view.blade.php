            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('departments.edit', $department->id) }}" class="btn btn-warning btn-sm" title="Edit">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 d-flex justify-content-between">
                    ...
                    @if(isset($department->status))
                        <span class="badge 
                            @if($department->status == 'active') bg-success @endif
                            @if($department->status == 'inactive') bg-danger @endif
                            @if($department->status == 'pending') bg-warning @endif">
